...
static void clbuildExecutable()
{
	...
	err = clGetKernelWorkGroupInfo(kernel, devices[deviceUsed], CL_KERNEL_WORK_GROUP_SIZE,
	                               sizeof(ret_val_size), &ret_val_size, NULL);
	checkError("clGetKernelWorkGroupInfo", err);
